...
conn = psycopg2.connect(database="flask_db", user="postgres", 
						password="adminadmin", host="172.23.0.1", port="5432") 
...
def delete(): 
	conn = psycopg2.connect (database="flask_db", user="postgres", password="root", host="172.23.0.1", port="5432") 
	cur = conn.cursor() 
